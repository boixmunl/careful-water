...
export const Cities: Array<City> = [
    {
      ...
      created_at: new Date("2022-06-20T12:09:47.921Z"),
      updated_at: new Date("2022-06-20T12:09:47.921Z")
    },
    {
      id: 2,
      title: "Barcelona",
      ...
      created_at: new Date("2022-06-20T12:09:47.924Z"),
      updated_at: new Date("2022-06-20T12:09:47.924Z")
    },
    {
      id: 3,
      title: "Berlin",
      ...
      created_at: new Date("2022-06-20T12:09:47.927Z"),
      updated_at: new Date("2022-06-20T12:09:47.927Z")
    }
  ];